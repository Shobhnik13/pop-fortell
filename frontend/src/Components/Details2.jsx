...
const Details2 = () => {
  return (
    <div>
    <div className='flex bg-[#101010] space-x-8 mt-[200px] w-[90%] m-auto rounded-3xl hover:bg-black cursor-pointer items-center'>
...
<img src={pred} alt="" className='rounded-lg'/>
    ...
    <div className='flex  w-[90%] m-auto rounded-3xl  bg-[#101010] mt-12 hover:bg-black cursor-pointer items-center'>
        <div className="img mt-16 px-6 w-[40%] ">
