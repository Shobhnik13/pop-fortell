...
const User = () => {
  ...
  return (
    <div className="bg-black h-[200vh] bg-[url('./assets/tiles.svg')] p-12">
    {/* <Navbar/> */}
    <div data-aos="fade-down"className=' flex flex-col  w-[80%] m-auto bg-[#101010] rounded-2xl p-4 hover:bg-black hover:cursor-pointer'>
