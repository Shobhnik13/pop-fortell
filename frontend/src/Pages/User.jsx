...
const User = () => {
  return (
    ...
    <Navbar/>
    <div className=' flex flex-col mt-10 w-[80%] m-auto bg-[#101010] rounded-2xl p-2 hover:bg-black hover:cursor-pointer'>
